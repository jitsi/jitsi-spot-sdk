 ...
 */
export default class SpotNearbyDevice extends PureComponent {
    /**
     ...
     */
    render() {
        return (<View style={styles.deviceLine}>
                <View style={styles.iconContainer}>
                    <TVIcon fill={COMPONENT_COLOR} height={DEVICE_ICON_SIZE} width={DEVICE_ICON_SIZE}/>
                </View>
    ...
    renderDeviceInfo() {
        ...
        return [
            (<Text key={infoArray[0]} style={[styles.deviceInfoLine, styles.deviceInfoLine1]}>
                    {infoArray[0]}
                </Text>),
            (<View key='deviceInfoSeparator' style={styles.deviceInfoSeparator}/>),
            (<Text key={infoArray[1]} style={[styles.deviceInfoLine, styles.deviceInfoLine2]}>
                    {infoArray[1]}
                </Text>)
        ];
    }
